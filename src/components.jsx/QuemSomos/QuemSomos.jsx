...
export default function QuemSomos(){
    return(
        <section className={styles.containerQuemSomos}>
            <div className={styles.boxQuemSomos}>
                ...
                <p>Há anos, trabalhamos aproximando quem quer ajudar de quem precisa, promovendo ações sociais estruturadas, transparentes e alinhadas às necessidades das comunidades. Acreditamos que a transformação acontece quando propósito, colaboração e responsabilidade caminham juntos.
</p>
